# --- FASE 1: INPUT BATAS TOTAL HARGA ---
while True:
    try:
...
total_harga = 0
daftar_belanja_user = {} # Menggunakan dictionary {nama: harga} untuk memudahkan penghapusan

print(f"\nTarget belanja yang harus dicapai adalah: Rp{TARGET_HARGA}")

# --- LOOPING UTAMA (Fase Validasi dan Penyesuaian) ---
# Loop akan terus berjalan selama total_harga TIDAK SAMA DENGAN TARGET_HARGA
...
# --- LOOPING SELESAI (total_harga == TARGET_HARGA) ---
print("\n==================================")
